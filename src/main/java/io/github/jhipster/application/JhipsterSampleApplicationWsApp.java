...
public class JhipsterSampleApplicationWsApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterSampleApplicationWsApp.class);

    private final Environment env;

    public JhipsterSampleApplicationWsApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterSampleApplicationWS.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterSampleApplicationWsApp.class);
